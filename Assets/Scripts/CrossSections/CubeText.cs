...
public class CubeText : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerClickHandler, IPointerUpHandler, IDragHandler
{
    ...
    private GizmoBehaviour cubeScript;
    ...
    private void Start()
    {
        cubeScript = GetComponentInParent<GizmoBehaviour>();
    ...
    public void OnPointerExit(PointerEventData eventData)
    {
        ...
        mouseOver = false;
        GameRaycastObject.instance.raycastBlocked = false;
    }

    public void OnPointerDown(PointerEventData eventData)
    {
        //We block the main raycast so we don't click other things
        GameRaycastObject.instance.raycastBlocked = true;
    }
