    ...
    public void UpdateButtons()
    {
        ...
        if(upHierarchyBtn != null)
        {
            if (SelectedObjectsManagement.Instance.lastParentSelected == null)
                ...
                upHierarchyBtn.interactable = SelectedObjectsManagement.Instance.lastParentSelected.parent.CompareTag("GlobalParent") != true;
        }
